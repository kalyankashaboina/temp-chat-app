...
export function AudioWaveform({ audioUrl, duration: initialDuration, className, compact }: AudioWaveformProps) {
  ...
  return (
    <div className={cn('flex items-center gap-2', className)}>
      ...
      {/* Waveform */}
      <div 
        className="flex-1 flex items-center gap-[2px] cursor-pointer h-8"
        onClick={handleSeek}
      >
      ...
      <div className="flex items-center gap-2 text-xs text-muted-foreground">
        ...
        {!compact && (
          <button
            ...
            className="px-1.5 py-0.5 rounded bg-muted hover:bg-muted-foreground/20 text-[10px] font-medium"
          >
            {playbackRate}x
          </button>
        )}
