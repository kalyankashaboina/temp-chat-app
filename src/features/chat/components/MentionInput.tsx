      ...
      <AnimatePresence>
        {showSuggestions && suggestions.length > 0 && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-full left-0 right-0 z-50 mb-2 overflow-hidden rounded-xl border border-border bg-popover shadow-xl"
          >
            <div className="p-1">
              ...
              {suggestions.map(({ user, isSelected }, index) => (
                ...
                >
                  ...
                  {user.isOnline && <div className="h-2 w-2 rounded-full bg-green-500" />}
                </motion.button>
              ))}
            </div>
          </motion.div>
