  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {userNames.length === 1 ? (
            <div className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-primary/20 bg-gradient-to-br from-primary/20 to-primary/40 text-xs font-bold text-primary">
            ...
            <div className="flex -space-x-2">
              {userNames.slice(0, 3).map((name, i) => (
                <motion.div
                  ...
                  className="flex h-7 w-7 items-center justify-center rounded-full border-2 border-background bg-gradient-to-br from-primary/20 to-primary/40 text-[10px] font-bold text-primary"
                >
        ...
        <div className="flex flex-col gap-1">
          {/* Typing bubble */}
          <motion.div
            className="relative rounded-2xl rounded-bl-md border border-border bg-card px-4 py-3 shadow-sm"
