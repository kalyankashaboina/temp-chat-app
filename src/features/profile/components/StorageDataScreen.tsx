            ...
            {isLoading ? (
              ...
              stats && (
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      <button
                        ...
                        className="flex w-full items-center gap-4 rounded-xl border border-border bg-card p-4 text-left transition-colors hover:bg-muted/50 disabled:opacity-50"
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {stats.cacheSize === 0
                              ? 'Cache is empty'
                              : `Free up ${formatBytes(stats.cacheSize)}`}
                          </p>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Delete all messages, media, and settings
                          </p>
                        </div>
                      </button>
                    </div>
                  ...
                  >
                    <h4 className="mb-2 text-sm font-medium">💡 Save Data</h4>
                    <p className="text-xs text-muted-foreground">
      ...
      <Dialog open={showClearAllDialog} onOpenChange={setShowClearAllDialog}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              This will permanently delete all your messages, media files, and app settings. This
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleClearAllData} disabled={isClearingAll}>
              {isClearingAll && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
              Clear All
            </Button>
          </DialogFooter>
        </DialogContent>
